    ...
    return (
        <div className="contactContainer">
            <Link to={ROUTES.MAIN_VIEW}><span className="close" /></Link>
                ...
                <h3 className="contactEmail">e-mail: giancarloguerrero1@gmail.com</h3>
                ...
                <h2 className="contactName">Manager Orkiestry- Natalia Klingbajl</h2>
                <h3 className="contactTel">tel. kom. : 517818321</h3>
                <h3 className="contactEmail">e-mail: Natalia.Klingbajl@nfm.wroclaw.pl</h3>
                <h2 className="contactName">Konserwator- Krzysztof Frąk</h2>
                <h3 className="contactTel">tel. kom. : 661 497 982</h3>
                <h3 className="contactEmail">e-mail: kszysztof.frak@nfm.wroclaw.pl</h3>
            </div>
        </div>
    )
}
