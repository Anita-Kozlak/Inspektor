            ...
            <Link to={ROUTES.MAIN_VIEW}><a href="#" className="close" /></Link>
                <div className="notesList">
                        <h2 className="instrumentNotes">I skrzypce:</h2>
                          <a href="https://ks4.imslp.net/files/imglnks/usimg/d/df/IMSLP19899-PMLP01586-Beethoven_Symphony_5_V1.pdf">Piotr Czajkowski: V Symfonia</a>
                        <a href="">Wolfgang Amadeusz Mozart: Uwertura do opery Wesele Figara</a>
                        <h2 className="instrumentNotes">II skrzypce</h2>
                        <a href="">Wolfgang Amadeusz Mozart: Uwertura do opery Wesele Figara</a>
                        <a href="https://ks4.imslp.net/files/imglnks/usimg/d/df/IMSLP19899-PMLP01586-Beethoven_Symphony_5_V1.pdf"> Piotr Czajkowski: V Symfonia</a>
                        <h2 className="instrumentNotes">Altówka</h2>
                        <a href="">Wolfgang Amadeusz Mozart: Uwertura do opery Wesele Figara</a>
                        <a href="">Piotr Czajkowski: V Symfonia</a>
